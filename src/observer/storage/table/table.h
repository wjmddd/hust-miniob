...
public:
  ...
  // TODO refactor
  RC create_index(Trx *trx, const vector<const FieldMeta *> &field_metas, const char *index_name, const bool isUnique);
...
private:
  ...
  RC update_entry_of_indexes(FieldMeta *targetFiled, const char *old_record, const char *new_record, const RID &rid);
